    ...
    <nav className="fixed top-0 left-0 w-full z-50 bg-white shadow-md px-6 py-3 flex justify-between items-center">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 cursor-pointer text-green-700 hover:bg-green-50 rounded-lg transition font-medium focus:outline-none"
        >
          <ShoppingCart size={18} /> <span>My Cart</span>
        </button>
        <button
